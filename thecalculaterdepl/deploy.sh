#!/usr/bin/env bash
# deploy.sh – Deploys thecalculaterspin on SpinKube / k3d with KEDA HTTP scale-to-zero
...
SPIN_APP_DIR="${REPO_ROOT}/thecalculaterspin"
...
wait_rollout default deployment/thecalculaterspin
ok "SpinApp running"
